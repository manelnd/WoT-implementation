...
export interface Keyboard {
     ...
     */
    toggleKey(key: KeyboardButton | KeyboardButton[], state: boolean, delay?: Delay): Promise<void>;
    /**
     ...
     */
    sendKey(key: KeyboardButton | KeyboardButton[], delayAfterPress?: Delay, delayAfterRelease?: Delay): Promise<void>;
    readonly sendKeys: CancelableFunction<{
         ...
         */ (keys: (KeyboardButton | KeyboardButton[])[], delayAfterPress?: Delay, delayAfterRelease?: Delay, delay?: Delay): Promise<void>;
    }>;
...
export interface Mouse extends Pick<_Worker, "getPos"> {
     ...
     */
    click(button?: MouseButton, delayAfterPress?: Delay, delayAfterRelease?: Delay): Promise<void>;
    /**
    ...
    readonly humanMoveTo: CancelableFunction<{
         ...
         */
        (x: number, y: number, speed?: number, deviation?: number, delay?: Delay): Promise<void>;
    }>;
    /**
...
export interface Workwindow extends Pick<_Worker, "refresh" | "setForeground" | "isForeground" | "isOpen" | "capture" | "kill" | "close" | "getView" | "setView"> {
    set: SetWorkwindow;
    get(): WindowInfo;
    colorAt: {
        /**
