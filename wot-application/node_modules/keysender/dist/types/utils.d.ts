export type SetWorkwindow = {
    ...
    (parentHandle: number, childClassName: string | null, childTitle?: string | null): void;
    ...
    (parentTitle: string | null, parentClassName: string | null, childClassName: string | null, childTitle?: string | null): void;
};
